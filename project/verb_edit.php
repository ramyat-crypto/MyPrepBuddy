...
$con = $db->connect();
$id=$_GET['id'];
$query="select * from verbal_table where V_id='".$id."'";
...
<html lang="en">
    ...
    <head>
        ...
        <title> Edit Verbal Questions</title>
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary" >     
                            ...
                            <div class="panel-heading" >
                                <h4>Edit Verbal Questions</h4>
                            </div>
                            <div class="panel-body">
                               
                                <form  action="verb_edit_script.php?id=<?php echo $row['V_id'] ?>" method="post" enctype="multipart/form-data">
