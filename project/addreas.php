...
<html>
  <head>
        ...
        <title> Add Logical Questions</title>
...
<div id="content">
        ...
        <div id="ifText" style="display: none;">
           <form  action="addreasscript.php?id=text" method="post" enctype="multipart/form-data">
            ...
            <div id="ifImg" style="display: none;">
               <form  action="addreasscript.php?id=image" method="post" enctype="multipart/form-data">
                  <div class="form-group"><!--restaurant_name-->
            ...
            <div id="ifMq" style="display: none;">
               <form  action="addreasscript.php?id=mq" method="post" enctype="multipart/form-data">
                             <div class="form-group"><!--restaurant_name-->
