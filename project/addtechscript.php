...
if($radioVal == "text")
{
$result=mysqli_query($con,"SELECT T_id FROM technical_table ORDER BY T_id DESC LIMIT 1");
...
$query = "Insert into technical_table(T_id,Question,Option_1,Option_2,Option_3,Option_4,Answer) values ('$prev_id','$question','$option_1','$option_2','$option_3','$option_4','$answer')";
   ...
   if (array(null) !== $line) { 
	...
	$prev_id="T0".$prev_id;
		  ...
		  $ary=$line;
		   ...
		   $query = "Insert into technical_table(T_id,Question,Option_1,Option_2,Option_3,Option_4,Answer) values ('$prev_id','$ary[0]','$ary[1]','$ary[2]','$ary[3]','$ary[4]','$ary[5]')";
