...
<?php include_once("./navbar/navbar.php"); ?>
 ...
 <div id="test_form" style='transform: scale(0.90); position: relative; top: 2px; background-color: rgba(177,156,217,0.4);'>
              <center><div id="timer"></div></center>
               <p style="background-color:green; color: white;padding-left: 20px">LOGICAL QUIZ</p><br>
            ...
            $quiz_query = "SELECT * FROM logical_table ORDER BY RAND() LIMIT 20;";
                    ...
                    <div style="padding-left: 30px; " id="content_block" >
                      ...
                      <form>
                        ...
                        <button class="saveBtn" type="button" onclick="validate(choice.value,'<?php echo $row["Answer"]; ?>','<?php echo $row["L_id"] ?>')">Save</button>
                      </form>
