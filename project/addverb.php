...
<html>
  <head>
        ...
        <title> Add Verbal Questions</title>
...
<div id="content">
        ...
        <div id="ifText" style="display: none;">
           <form  action="addverbscript.php?id=text" method="post" enctype="multipart/form-data">
            ...
            <div id="ifImg" style="display: none;">
               <form  action="addverbscript.php?id=image" method="post" enctype="multipart/form-data">
                  <div class="form-group"><!--restaurant_name-->
            ...
            <div id="ifMq" style="display: none;">
               <form  action="addverbscript.php?id=mq" method="post" enctype="multipart/form-data">
                             <div class="form-group"><!--restaurant_name-->
