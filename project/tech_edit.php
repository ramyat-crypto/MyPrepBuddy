...
$con = $db->connect();
$id=$_GET['id'];
$query="select * from technical_table where T_id='".$id."'";
...
<html lang="en">
    ...
    <head>
        ...
        <title> Edit Technical Questions</title>
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary" >     
                            ...
                            <div class="panel-heading" >
                                <h4>Edit Technical Questions</h4>
                            </div>
                            <div class="panel-body">
                               
                                <form  action="tech_edit_script.php?id=<?php echo $row['T_id'] ?>" method="post" enctype="multipart/form-data">
