...
<body>
 ...
 <div id="test_form" style='transform: scale(0.90); position: relative; top: 2px; background-color: rgba(177,156,217,0.4);'>
              <center><div id="timer"></div></center>
               <p style="background-color:green; color: white;padding-left: 20px">APTITUDE QUIZ</p><br>
            ...
            $quiz_query = "SELECT * FROM aptitude_table ORDER BY RAND() LIMIT 20;";
                      ...
                      <h2><b><?php 
                          $allowTypes = array('jpg','png','jpeg','gif','pdf');
                            ...
                            if(in_array($fileType, $allowTypes)){
                             ...
                             echo $count.")".$row["Question"];}  //echo $row["Answer"]; ?></b></h2><br>
                      <form method="post">
                        ...
                        <button class="saveBtn" type="button" onclick="validate(choice.value, '<?php echo $row["Answer"]; ?>','<?php echo $row["A_id"]; ?>');">Save</button>
            ...
            var arylist=[];
            var validate = function(selected_value, rightanswer, form) {

            var ary=[selected_value,rightanswer,form];
            arylist.push(ary);
            ...
            if (selected_value.localeCompare(rightanswer)==0) {
                rightAnswerCount++;

            }
            if (selected_value.localeCompare("")==0) {
                unansweredCount++;
