...
if($radioVal == "text")
{
$result=mysqli_query($con,"SELECT A_id FROM aptitude_table ORDER BY A_id DESC LIMIT 1");
...
$query = "Insert into aptitude_table(A_id,Question,Option_1,Option_2,Option_3,Option_4,Answer) values ('$prev_id','$question','$option_1','$option_2','$option_3','$option_4','$answer')";
   ...
   if (array(null) !== $line) { 
	...
	$prev_id="A0".$prev_id;
		  ...
		  $ary=$line;
		   ...
		   $query = "Insert into aptitude_table(A_id,Question,Option_1,Option_2,Option_3,Option_4,Answer) values ('$prev_id','$ary[0]','$ary[1]','$ary[2]','$ary[3]','$ary[4]','$ary[5]')";
...
// $question = mysqli_real_escape_string($con, $question);
// } else{
// $question=$_FILES["image"]["name"];
// move_uploaded_file($_FILES["image"]['tmp_name'],"images/ImgQuestions/".$_FILES['image']['name']);
// }
