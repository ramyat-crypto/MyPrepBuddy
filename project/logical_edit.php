...
$con = $db->connect();
$id=$_GET['id'];
$query="select * from logical_table where L_id='".$id."'";
...
<html lang="en">
    ...
    <head>
        ...
        <title> Edit Logical Questions</title>
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary" >     
                            ...
                            <div class="panel-heading" >
                                <h4>Edit Logical Questions</h4>
                            </div>
                            <div class="panel-body">
                               
                                <form  action="logical_edit_script.php?id=<?php echo $row['L_id'] ?>" method="post" enctype="multipart/form-data">
