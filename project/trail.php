...
<div id="content">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary" >     
                            ...
                            <div class="panel-body">
                                ...
                                <form  action="addaptiscript.php" method="post" enctype="multipart/form-data">

					Text  <input type="radio" onclick="javascript:text_img_mq_Check();" name="yesno" id="textCheck" > 
					Image <input type="radio" onclick="javascript:text_img_mq_Check();" name="yesno" id="imageCheck"> 
					Multiple<input type="radio" onclick="javascript:text_img_mq_Check();" name="yesno" id="mqCheck"><br>
		    ...
		    <div id="ifText" style="display: none;">
		        ...
		        <div id="ifImg" style="display: none;">
		        	...
		        	<div class="form-group"><!--restaurant_name-->
                                     <label for="image">Option_1:</label>
                                            <input type="file"  name="o1" />
		        	</div>
		        	<div class="form-group"><!--restaurant_name-->
                                     <label for="image">Option_2:</label>
                                            <input type="file"  name="o2" />
		        	</div>
		        	<div class="form-group"><!--restaurant_name-->
                                     <label for="image">Option_3:</label>
                                            <input type="file"  name="o3" />
		        	</div>
		        	<div class="form-group"><!--restaurant_name-->
                                     <label for="image">Option_4:</label>
                                            <input type="file"  name="o4" />
		        	</div>
		        	<div class="form-group"><!--restaurant_name-->
